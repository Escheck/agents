...
public class BidSpaceExtractor_opening extends OfferingStrategy {
	...
	private String pre_calculations(HashMap<java.lang.Integer, Value> bidP, String n_bid) throws Exception {
		...
		if (distrib == "neighborhood") {
			...
			n_bid = org.apache.commons.lang.StringUtils.leftPad(Integer.toBinaryString(counter_neighborhood),
					this.max_issues, "0");
		...
		if (distrib == "enumeration") {
			...
			n_bid = org.apache.commons.lang.StringUtils.leftPad(Integer.toString(counter_neighborhood, 3),
					this.max_issues, "0");
		}
		...
		if (distrib == "resampled_stoch_neighborhood" || distrib == "resampled_stoch_neighborhood_uni_style"
			...
			n_bid = org.apache.commons.lang.StringUtils.leftPad(Integer.toBinaryString(sample_direction),
					this.max_issues, "0");
	...
	public String getName() {
		return "2014 - BidSpaceExtractor opening";
	}
