...
public class Gahboninho extends Agent {
	...
	public Action chooseAction() {
		try {
			...
			++RoundCount;
			if (WereBidsFiltered == false && (timeline.getTime() > IM.GetDiscountFactor() * 0.9 || timeline.getTime()
					+ 3 * IM.BidsCreationTime > 1)) /*
													 * we must filter to make
													 * last bids efficient
													 */
			{
	...
	public String getDescription() {
		return "ANAC 2011 - Gahboninho (compatible with non-linear utility spaces)";
	}
