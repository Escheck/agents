...
public class Reflectivity {
	...
	private int numberOfLayers = 0; // number of layers including the
									// semi-infinite layer at both outer faces
	private int numberOfInterfaces = 0; // number of interlayer interfaces, i.e.
										// number of layers minus one

	private Complex[][] refractiveIndices = null; // refractive indices of the
													// layers at all wavelengths
													// (number of wavelength,
													// number of layers)
	private Complex[] meanRefractiveIndices = null; // mean refractive indices
													// of each layer
	private boolean refractSet = false; // = true when refractive indices
										// entered
	private boolean[] refractLayerSet = null; // = true for layer i when
												// refractive indices entered
												// for layer i
	private boolean meanRefractUsed = false; // = true when mean refractive
												// indices used

	private Complex[][] relativeMagneticPermeabilities = null; // relative
																// magnetic
																// permeabilities
																// of the layers
																// default
																// values = 1.0
	private Complex[] meanRelativeMagneticPermeabilities = null;// mean relative
																// magnetic
																// permeabilities
																// of the layers
	private boolean magneticSet = false; // = true when relative magnetic
											// permeabilities entered
	private boolean meanMagneticUsed = false; // = true when mean relative
												// magnetic permeabilities used

	private double[][] absorptionCoefficients = null; // absorption coefficents
														// of the layers at all
														// wavelengths
														// default values = 0.0;
	private boolean absorbSet = false; // = true when absorbtivity or extinction
										// coefficients entered

	private double[] thicknesses = null; // thicknesses (in metres) of the
											// layers
	...
	private boolean[] thickLayerSet = null; // = true for layer i when
											// thicknesses entered for layer i

	private int numberOfWavelengths = 0; // number of wavelengths in wavelength
											// scan
	...
	private int[] origWavelIndices = null; // indices of the wavelengths as
											// entered before sort into lowest
											// to highest
	private boolean wavelSet = false; // = true when wavelengths entered
	private boolean freqSet = false; // = true when frequencies entered
	private boolean wavelNumberSet = false; // = true when number of wavelengths
											// set

	private double[] incidentAngleDeg = null; // incident angles measured from
												// the normal in degrees
	private double[] incidentAngleRad = null; // incident angles measured from
												// the normal in radians
	private int[] incidentAngleIndices = null; // indices of original incident
												// angles after sorting into
												// ascending order
	private int numberOfIncidentAngles = 0; // number of incident angles in
											// angular scan
	private boolean incidentAngleSet = false; // = true when the incident angles
												// have been entered

	private String mode = null; // polarisation mode: TE, TM, unpolarised or
								// mixed
	private double eVectorAngleDeg = 0.0D; // angle between the electric vector
											// of the incident light and
											// the plane normal to the
											// reflecting surfac in degrees
	private double eVectorAngleRad = 0.0D; // angle between the electric vector
											// of the incident light and
											// the plane normal to the
											// reflecting surfac in radians
	...
	private Complex[][][] koVector = null; // ko vector [wavelength] [incident
											// angle] [layer]
	private Complex[][][] kVector = null; // k vector [wavelength] [incident
											// angle] [layer]
	private Complex[][][] kxVector = null; // kx vector [wavelength] [incident
											// angle] [layer]
	private Complex[][][] kzVector = null; // kz vector [wavelength] [incident
											// angle] [layer]

	private double[][] reflectivities = null; // reflectivities [wavelength]
												// [incident angle]
	private double[][] transmissivities = null; // transmissivities [wavelength]
												// [incident angle]
	private double[][] powerLosses = null; // power loss on transmission
											// relative to an input power of 1mW
											// over 1 sq. metre [wavelength]
											// [incident angle]
	private Complex[][] reflectCoeffTE = null; // TE reflection coefficient
												// [wavelength] [incident angle]
	private Complex[][] reflectCoeffTM = null; // TM reflection coefficient
												// [wavelength] [incident angle]
	private Complex[][] transmitCoeffTE = null; // TE transmission coefficient
												// [wavelength] [incident angle]
	private Complex[][] transmitCoeffTM = null; // TM transmissiom coefficient
												// [wavelength] [incident angle]

	private double[][] reflectPhaseShiftRadTE = null; // TE reflection phase
														// shift (radians)
														// [wavelength]
														// [incident angle]
	private double[][] reflectPhaseShiftRadTM = null; // TM reflection phase
														// shift (radians)
														// [wavelength]
														// [incident angle]
	private double[][] transmitPhaseShiftRadTE = null; // TE transmission phase
														// shift (radians)
														// [wavelength]
														// [incident angle]
	private double[][] transmitPhaseShiftRadTM = null; // TM transmissiom phase
														// shift (radians)
														// [wavelength]
														// [incident angle]
	private double[][] reflectPhaseShiftDegTE = null; // TE reflection phase
														// shift (degrees)
														// [wavelength]
														// [incident angle]
	private double[][] reflectPhaseShiftDegTM = null; // TM reflection phase
														// shift (degrees)
														// [wavelength]
														// [incident angle]
	private double[][] transmitPhaseShiftDegTE = null; // TE transmission phase
														// shift (degrees)
														// [wavelength]
														// [incident angle]
	private double[][] transmitPhaseShiftDegTM = null; // TM transmissiom phase
														// shift (degrees)
														// [wavelength]
														// [incident angle]

	private double[][] evanescentFields = null; // integrated evanescent fields
												// [wavelength] [incident angle]
	private double fieldDistance = Double.POSITIVE_INFINITY; // distance into
																// evanescent
																// field over
																// which
																// intensity is
																// integrated
	private boolean fieldIntensityCalc = false; // = true when field intensity
												// calculated for non-infinite
												// field distance
	private double[][] penetrationDepths = null; // Evanescent field penetration
													// depth [wavelength]
													// [incident angle]
	private double[][] transmitAnglesRad = null; // transmitted angles in
													// radians [wavelength]
													// [incident angle]
	private double[][] transmitAnglesDeg = null; // transmitted angles in
													// degrees [wavelength]
													// [incident angle]

	private boolean singleReflectCalculated = false; // = true when only a
														// single angular
														// relectivity has been
														// calculated
	private boolean angularReflectCalculated = false; // = true when an angular
														// relectivity scan has
														// been calculated
	private boolean wavelengthReflectCalculated = false; // = true when an
															// wavelength
															// relectivity scan
															// has been
															// calculated
	private boolean wavelengthAndAngularReflectCalculated = false; // = true
																	// when
																	// angular
																	// for each
																	// wavelength
	...
	private double mu0overEps0 = Fmath.MU_0 / Fmath.EPSILON_0; // permeability
																// of free space
																// over
																// permittivity
																// of free space
	private double impedance = Math.sqrt(mu0overEps0); // characteristic
														// impedance of free
														// space

	private int wavelengthAxisOption = 1; // = 1 when wavelength/frequency
											// x-axis in plotting methods =
											// wavelength
											// = 2 when wavelength/frequency
											// x-axis in plotting methods =
											// frequency, Hz
											// = 3 when wavelength/frequency
											// x-axis in plotting methods =
											// radians

	private double[] experimentalData = null; // experimental data [incident
												// angle]
	private double[] experimentalWeights = null; // error in each experimental
													// point [incident angle]
	...
	private boolean experimentalDataSet = false; // = true when experimental
													// data entered
	private boolean weightingOption = false; // = true if experimental
												// weightings (other than unity)
												// entered

	private int numberOfEstimatedParameters = 0; // number of parameters to be
													// estimated in non-linear
													// regression method
	private int[] thicknessEstimateIndices = null; // indices of the thicknesses
													// to be estimated by
													// non-linear regression
	private int[] refractIndexRealEstimateIndices = null; // indices of the
															// Real[refractive
															// indices] to be
															// estimated by
															// non-linear
															// regression
	private int[] refractIndexImagEstimateIndices = null; // indices of the
															// Imag[refractive
															// indices] to be
															// estimated by
															// non-linear
															// regression
	private int[] absorptionCoeffEstimateIndices = null; // indices of the
															// absorption
															// coefficients to
															// be estimated by
															// non-linear
															// regression
	private int[] magneticPermRealEstimateIndices = null; // indices of the
															// Real[relative
															// magnetic
															// permeability] to
															// be estimated by
															// non-linear
															// regression
	private int[] magneticPermImagEstimateIndices = null; // indices of the
															// Imag[relative
															// magnetic
															// permeability] to
															// be estimated by
	...
	private boolean refractIndexImagEstimateSet = false; // = true when indices
															// of the
															// Imag[refractive
															// indices] set
	private boolean absorptionCoeffEstimateSet = false; // = true when indices
														// of the absorption
														// coefficients set

	private int thicknessEstimateNumber = 0; // number of the thicknesses to be
												// estimated by non-linear
												// regression
	private int refractIndexRealEstimateNumber = 0; // number of the
													// Real[refractive indices]
													// to be estimated by
													// non-linear regression
	private int refractIndexImagEstimateNumber = 0; // number of the
													// Imag[refractive indices]
													// to be estimated by
													// non-linear regression
	private int absorptionCoeffEstimateNumber = 0; // number of the absorption
													// coefficients to be
													// estimated by non-linear
													// regression
	private int magneticPermRealEstimateNumber = 0; // number of the
													// Real[relative magnetic
													// permeabilities] to be
													// estimated by non-linear
													// regression
	private int magneticPermImagEstimateNumber = 0; // number of the
													// Imag[relative magnetic
													// permeabilities] to be
													// estimated by non-linear
													// regression

	private double fieldScalingFactor = 0.0D; // scaling factor between
	...
	public int degreesOfFreedom = 0; // degrees of freedom (non-linear
										// regression method)
	...
	public Reflectivity(int n) {
		...
		for (int i = 1; i < this.numberOfLayers - 2; i++)
	...
	public void setMode(String mode) {
		if (mode.equalsIgnoreCase("TE") || mode.equalsIgnoreCase("transverse electric")) {
			...
			if (mode.equalsIgnoreCase("TM") || mode.equalsIgnoreCase("transverse magnetic")) {
				...
				if (mode.equalsIgnoreCase("unpolarised") || mode.equalsIgnoreCase("unpolarized")
	...
	// Enter angle between incident light electric vector and the plane normal
	// to the reflecting plane in degrees
	...
	public void setIncidentAngle(double[] incidentAngle) {
		...
		if (this.experimentalDataSet) {
			if (this.numberOfDataPoints != this.numberOfIncidentAngles)
				throw new IllegalArgumentException("Number of experimental reflectivities " + this.numberOfDataPoints
						+ " does not equal the number of incident angles " + this.numberOfIncidentAngles);
	...
	// Enter a range of nAngles incident angles [degrees] ranging, in equal
	// increments from angleLow to angleHigh
	...
	public void setThicknesses(double[] thick) {
		...
		if (n != this.numberOfLayers - 2)
			throw new IllegalArgumentException("Number of thicknesses, " + n
					+ ", does not match the number of layers minus the outer two semi-finite layers, "
					+ (this.numberOfLayers - 2));
		for (int i = 1; i < this.numberOfLayers - 1; i++)
			this.thicknesses[i] = thick[i - 1];

		// Calculate distances
		this.distances[0] = 0.0D;
		for (int i = 1; i < this.numberOfInterfaces; i++)
	...
	public void setThicknesses(double thickness, int layerNumber) {
		if (layerNumber < 1 || layerNumber > this.numberOfLayers)
			throw new IllegalArgumentException(
					"Layer number, " + layerNumber + ", must be in the range 1 to " + this.numberOfLayers);
		...
		int check = 0;
		for (int i = 0; i < this.numberOfLayers - i; i++)
			if (this.thickLayerSet[i])
				check++;
		if (check == this.numberOfLayers)
			this.thickSet = true;
	}
	...
	public void setWavelength(double[] wavelengths) {
		...
		if (this.wavelNumberSet) {
			if (n != this.numberOfWavelengths)
				throw new IllegalArgumentException("The number of wavelengths entered, " + n
						+ ", does not equal that previously set," + this.numberOfWavelengths);
		}
		...
		if (!this.wavelNumberSet) {
			...
			// Calculate imaginary refractive indices arrays if absorption
			// coefficients have been entered
			// or otherwise set all absorption coefficients to zero
			if (this.absorptionCoefficients != null) {
				for (int i = 0; i < this.numberOfLayers; i++) {
					for (int j = 0; j < this.numberOfWavelengths; j++) {
						if (this.refractiveIndices[i][j].getImag() == 0.0D)
							this.refractiveIndices[j][i]
									.setImag(absorptionCoefficients[j][i] * this.wavelengths[j] / (4.0D * Math.PI));
					}
				}
			} else {
		...
		if (!freqSet) {
			...
			for (int i = 0; i < this.numberOfWavelengths; i++)
				this.frequencies[this.numberOfWavelengths - 1 - i] = Fmath.C_LIGHT / wavelengths[i];
		}

		// calculate radial frequencies
		this.omega = new double[this.numberOfWavelengths];
		for (int i = 0; i < this.numberOfWavelengths; i++)
			this.omega[i] = 2.0D * Math.PI * frequencies[i];
	...
	public void setFrequency(double[] frequency) {
		...
		if (this.wavelNumberSet) {
			if (n != this.numberOfWavelengths)
				throw new IllegalArgumentException("The number of frequencies entered, " + n
						+ ", does not equal that previously set," + this.numberOfWavelengths);
		}
		...
		for (int i = 0; i < n; i++)
			wavelength[i] = Fmath.C_LIGHT / frequencies[n - 1 - i];
		this.setWavelength(wavelength);
	}

	// Enter a range of nLambda wavelengths [metres] ranging, in equal
	// increments from lambdaLow to lambdaHigh
	...
	// Enter a range of nFreq frequencies [Hz] ranging, in equal increments from
	// freqLow to freqHigh
	...
	// with accompanying matchingrearrangement of the magnetic permeabilities
		...
		if (this.numberOfWavelengths > 1) {
			...
			while (test0) {
				if (this.wavelengths[ii] < this.wavelengths[ii - 1]) {
					...
					ii++;
					if (ii >= this.numberOfWavelengths)
						test0 = false;
				}
			}
			if (test1) {
	...
	public void setRefractiveIndices(Complex[][] refractiveIndices) {
		...
		if (n != this.numberOfLayers)
			throw new IllegalArgumentException("Number of refractive indices layers, " + n
					+ ", does not match the number of layers, " + this.numberOfLayers);
		int m = refractiveIndices.length;
		if (this.wavelSet) {
			if (m != this.numberOfWavelengths)
				throw new IllegalArgumentException("Number of refractive indices wavelength sets, " + m
						+ ", does not match the number of wavelengths already set, " + this.numberOfWavelengths);
		}
		...
		// enter imaginary refractive indices if absorption coefficients have
		// been entered
		if (this.wavelSet && this.absorptionCoefficients != null) {
			for (int i = 0; i < this.numberOfLayers; i++) {
				for (int j = 0; j < this.numberOfWavelengths; j++) {
					if (this.refractiveIndices[j][i].getImag() == 0.0D)
						this.refractiveIndices[j][i]
								.setImag(absorptionCoefficients[j][i] * this.wavelengths[i] / (4.0D * Math.PI));
				}
			}
		}
		// otherwise set absorption coefficients to zero
		if (!this.absorbSet)
			absorptionCoefficients = new double[this.numberOfWavelengths][this.numberOfLayers];
	...
	public void setRefractiveIndices(Complex[] refractiveIndices) {
		...
		if (n != this.numberOfLayers)
			throw new IllegalArgumentException("Number of refrative indices layers, " + n
					+ ", does not match the number of layers, " + this.numberOfLayers);
		...
		if (!this.magneticSet) {
			if (!this.meanMagneticUsed) {
				if (this.wavelNumberSet) {
					this.relativeMagneticPermeabilities = Complex.twoDarray(this.numberOfWavelengths,
							this.numberOfLayers, 1.0D, 0.0D);
				}
			} else {
				this.relativeMagneticPermeabilities = Complex.twoDarray(this.numberOfWavelengths, this.numberOfLayers);
				for (int i = 0; i < this.numberOfLayers; i++) {
	...
	public void setRefractiveIndices(double[] refractiveIndices) {
		int n = refractiveIndices.length;
		if (n != this.numberOfLayers)
			throw new IllegalArgumentException("Number of refrative indices, " + n
					+ ", does not match the number of layers, " + this.numberOfLayers);
	...
	public void setRefractiveIndices(Complex[] refractiveIndices, int layerNumber) {
		...
		if (this.wavelNumberSet) {
			if (n != this.numberOfWavelengths)
				throw new IllegalArgumentException("The number of refractive index wavelength values, " + n
						+ ", does not match the number of wavelengths already entered, " + this.numberOfWavelengths);

		} else {
			// Give dimensions to refractive index arrays - fill with mean if
			// known
			this.numberOfWavelengths = n;
			this.wavelNumberSet = true;
			...
			// Give dimensions to relative permeabilities arrays - fill with
			// mean if known
			this.relativeMagneticPermeabilities = Complex.twoDarray(this.numberOfWavelengths, this.numberOfLayers, 1.0D,
					0.0D);
		...
		// set imaginary refractive indices for this layer if some absorption
	...
	public void setAbsorptionCoefficients(double[] absorptionCoefficients) {
		...
		if (n != this.numberOfLayers)
			throw new IllegalArgumentException("Number of absorption coefficients sets, " + n
					+ ", does not match the number of layers, " + this.numberOfLayers);
		...
		if (this.refractSet) {
			for (int i = 0; i < this.numberOfLayers; i++) {
				if (this.refractiveIndices[0][i].getImag() == 0.0D)
					this.refractiveIndices[0][i]
							.setImag(this.absorptionCoefficients[0][i] * this.wavelengths[0] / (4.0D * Math.PI));
			}
		}
	}
	...
	public void setAbsorptionCoefficients(double[][] absorptionCoefficients) {
		...
		if (this.wavelNumberSet && m != this.numberOfWavelengths)
			throw new IllegalArgumentException("Number of absorption coefficients wavelengths, " + m
					+ ", does not match the number of wavelengths already entered, " + this.numberOfWavelengths);
	...
	// Enter absorption coefficients for a single layer [default = 0], range of
	// wavelengths
	public void setAbsorptionCoefficients(double[] absorptionCoefficients, int layerNumber) {
		...
		if (this.wavelNumberSet) {
			if (n != this.numberOfWavelengths)
				throw new IllegalArgumentException("Layer " + layerNumber
						+ ": number of absorption coefficients wavelengths, " + n
						+ ", does not match the number of wavelengths already entered, " + this.numberOfWavelengths);
		} else {
			this.numberOfWavelengths = n;
			this.refractiveIndices = Complex.twoDarray(this.numberOfWavelengths, this.numberOfLayers);
		...
		for (int j = 0; j < this.numberOfWavelengths; j++) {
			if (this.refractiveIndices[j][layerNumber].getImag() == 0.0D)
				this.refractiveIndices[j][layerNumber]
						.setImag(absorptionCoefficients[j] * this.wavelengths[j] / (4.0D * Math.PI));
		}
		this.absorbSet = true;
	}

	// Enter absorption coefficients for a single layer [default = 0], single
	// wavelength
	public void setAbsorptionCoefficients(double absorptionCoefficient, int layerNumber) {
		...
		if (this.wavelNumberSet) {
			if (this.numberOfWavelengths != 1)
				throw new IllegalArgumentException("Layer " + layerNumber
						+ ": number of absorption coefficients wavelengths, " + 1
						+ ", does not match the number of wavelengths already entered, " + this.numberOfWavelengths);
		} else {
		...
		if (this.refractiveIndices[0][layerNumber].getImag() == 0.0D)
			this.refractiveIndices[0][layerNumber]
					.setImag(absorptionCoefficient * this.wavelengths[0] / (4.0D * Math.PI));
	...
	public void setRelativeMagneticPermeabilities(Complex[][] relativeMagneticPermeabilities) {
		...
		if (n != this.numberOfLayers)
			throw new IllegalArgumentException("Number of relative magnetic permeabilities, " + n
					+ ", does not match the number of layers, " + this.numberOfLayers);
		int m = relativeMagneticPermeabilities.length;
		if (this.wavelNumberSet)
			if (m != this.numberOfWavelengths)
				throw new IllegalArgumentException("Number of relative magnetic permeabilities associated wavelengths, "
						+ m + ", does not match the number of wavelengths already entered, "
						+ this.numberOfWavelengths);
	...
	// Enter magnetic permeabilities as a mean value for each layer, complex
	// numbers [default values = 1.0]
	public void setRelativeMagneticPermeabilities(Complex[] relativeMagneticPermeabilities) {
	...
	// Enter magnetic permeabilities as a mean value for each layer, real
	// numbers [default values = 1.0]
	...
	// Enter magnetic permeabilities for a single layer, complex numbers
	// [default values = 1.0]
	public void setRelativeMagneticPermeabilities(Complex[] relativeMagneticPermeabilities, int layerNumber) {
		...
		if (this.wavelNumberSet) {
			if (n != this.numberOfWavelengths)
				throw new IllegalArgumentException("Layer " + layerNumber
						+ ": number of relative magnetic permeabilities associated wavelengths, " + n
						+ ", does not match the number of wavelengths already entered, " + this.numberOfWavelengths);
		}
		...
		Complex sum = Complex.zero();
		for (int i = 0; i < n; i++)
			sum.plusEquals(this.relativeMagneticPermeabilities[i][layerNumber - 1]);
		this.meanRelativeMagneticPermeabilities[layerNumber - 1] = sum.over(n);
	}

	// Enter magnetic permeabilities for a single layer, real numbers [default
	// values = 1.0]
	...
	// Enter mean magnetic permeability for a single layer, complex number
	// [default values = 1.0]
	...
	// Enter mean magnetic permeability for a single layer, real number [default
	// values = 1.0]
	public void setRelativeMagneticPermeabilities(double relativeMagneticPermeability, int layerNumber) {
		...
		if (this.relativeMagneticPermeabilities != null) {
			int n = this.relativeMagneticPermeabilities[0].length;
			for (int i = 0; i < n; i++)
				this.relativeMagneticPermeabilities[i][layerNumber
						- 1] = this.meanRelativeMagneticPermeabilities[layerNumber - 1];
		}
	}
	...
	// Return the integrated evanescent fields - default field depth
	// (POSITIVE_INFINITY)
	...
	// Calculation and plotting of the reflectivities for a single or multiple
	// wavelengths and a range of incident angles entered
	...
	// Calculation and plotting of the transmissivities for a single or multiple
	// wavelengths and a range of incident angles entered
	// No user legend provided
	...
	// Calculation and plotting of the power losses on transmission for a single
	// or multiple wavelengths and a range of incident angles entered
	// No user legend provided
	...
	// Calculation and plotting of the transmission angles for a single or
	// multiple wavelengths and a range of incident angles entered
	// No user legend provided
	...
	// Calculation and plotting of the absolute values of TE reflection
	// coefficients for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the absolute values of TM reflection
	// coefficients for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the absolute values of TE transmission
	// coefficients for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the absolute values of TM transmission
	// coefficients for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the integrated evanescent field for a single
	// or multiple wavelengths and a range of incident angles entered
	// No user legend provided
	...
	// Calculation and plotting of the integrated evanescent fields for a single
	// or multiple wavelengths and a range of incident angles entered
	...
	public void plotEvanescentFields(String legend) {
		...
		String graphLegendExtra = " Integrated Evanescent Field Intensities to a depth of " + this.fieldDistance
				+ " metres";
	...
	// Calculation and plotting of the evanescent field penetration depths for a
	// single or multiple wavelengths and a range of incident angles entered
	// No user legend provided
	...
	// Calculation and plotting of the phase shift on reflection (TE mode), in
	// degrees, for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the phase shift on reflection (TM mode), in
	// degrees, for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the phase shift on reflection (TE mode), in
	// radians, for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the phase shift on transmission (TE mode), in
	// degrees, for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	// Calculation and plotting of the phase shift on transmission (TM mode), in
	// degrees, for a single or multiple wavelengths and a range of incident
	// angles entered
	// No user legend provided
	...
	public void plotSimulation(String graphLegend, String graphLegendExtra, String yLegend, String yUnits,
			Object yValuesObject) {

		// Calculate yValuesObject internal array dimensions and fill yValues
		// array
	...
	public void checkWhichCalculation() {
		...
		if (test) {
				...
				for (int i = 0; i < this.numberOfWavelengths; i++) {
					for (int j = 0; j < this.numberOfIncidentAngles; j++) {
						if (this.kxVector[i][j][nkouter].getReal() == 0.0D) {
							...
							integratedEvanescentField += this.teFraction
									* Fmath.square(this.transmitCoeffTE[i][j].abs())
									* (1.0D - Math.exp(-2.0D * this.fieldDistance / penetrationDepth))
									* penetrationDepth / 2.0D;
							double refrTerm = this.refractiveIndices[i][0].getReal()
									/ this.refractiveIndices[i][j].getReal();
							double magnTerm = Math.sqrt(this.relativeMagneticPermeabilities[i][nkouter].getReal()
									/ this.relativeMagneticPermeabilities[i][0].getReal());
							integratedEvanescentField += this.teFraction
									* Fmath.square(this.transmitCoeffTM[i][j].abs()) * magnTerm * refrTerm
									* (1.0D - Math.exp(-2.0D * this.fieldDistance / penetrationDepth))
									* penetrationDepth / 2.0D;
						}
					}
			...
			this.koVector = Complex.threeDarray(this.numberOfWavelengths, this.numberOfIncidentAngles,
					this.numberOfLayers);
			this.kzVector = Complex.threeDarray(this.numberOfWavelengths, this.numberOfIncidentAngles,
					this.numberOfLayers);
			this.kVector = Complex.threeDarray(this.numberOfWavelengths, this.numberOfIncidentAngles,
					this.numberOfLayers);
			this.kxVector = Complex.threeDarray(this.numberOfWavelengths, this.numberOfIncidentAngles,
					this.numberOfLayers);
			...
			for (int i = 0; i < this.numberOfWavelengths; i++) {
				for (int j = 0; j < this.numberOfIncidentAngles; j++) {
					for (int k = 0; k < this.numberOfLayers; k++) {
						...
						// Calculate k vector
						this.kVector[i][j][k] = this.koVector[i][j][k].times(this.refractiveIndices[i][k])
								.times(Complex.sqrt(this.relativeMagneticPermeabilities[i][k]));

						// Calculate kz vector
						this.kzVector[i][j][k] = this.koVector[i][j][k].times(this.refractiveIndices[i][0])
								.times(Complex.sqrt(this.relativeMagneticPermeabilities[i][0]));
						this.kzVector[i][j][k] = this.kzVector[i][j][k].times(Math.sin(this.incidentAngleRad[j]));

						// Calculate kx vector
						this.kxVector[i][j][k] = (Complex.square(this.kVector[i][j][k]))
								.minus(Complex.square(this.kzVector[i][j][k]));
						this.kxVector[i][j][k] = Complex.sqrt(this.kxVector[i][j][k]);
						// if(this.kxVector[i][j][k].getImag()>0.0D)this.kxVector[i][j][k]
						// = this.kxVector[i][j][k].times(Complex.minusOne());
	...
	// Calculation of the reflection coefficient for a single or multiple
	// wavelengths and a single or range of incident angles entered
	public void scan() {
		if (!this.wavelSet)
		...
		if (!this.modeSet)
			throw new IllegalArgumentException(
					"No polaristaion mode (TE, TM, unpolarised or mixed[angle to be entered]) has been entered");
		...
		if (this.numberOfWavelengths == 1) {
			if (this.numberOfIncidentAngles == 1) {
				this.singleReflectCalculated = true; // = true when only a
														// single angular
														// relectivity has been
														// calculated
			} else {
				this.angularReflectCalculated = true; // = true when an angular
														// relectivity scan has
														// been calculated
			}
		} else {
			if (this.numberOfIncidentAngles == 1) {
				this.wavelengthReflectCalculated = true; // = true when a
															// wavelength
															// relectivity scan
															// has been
															// calculated
			} else {
				this.wavelengthAndAngularReflectCalculated = true; // = true
																	// when
																	// angular
																	// for each
																	// wavelength
	...
	public double[] calcTEreflectivity(int wavelengthIndex, int angleIndex) {
		...
		if (this.numberOfLayers == 2) {
			tempc1 = this.relativeMagneticPermeabilities[wavelengthIndex][1]
					.times(this.kxVector[wavelengthIndex][angleIndex][0]);
			tempc2 = this.relativeMagneticPermeabilities[wavelengthIndex][0]
					.times(this.kxVector[wavelengthIndex][angleIndex][1]);
			...
			// Calculate cos(theta[1]), beta[1], cos[beta[1]], sin[beta[1]],
			// p[1]
			Complex costheta = this.kxVector[wavelengthIndex][angleIndex][1]
					.over(this.kVector[wavelengthIndex][angleIndex][1]);
			Complex pTerm = (this.refractiveIndices[wavelengthIndex][1].over(this.impedance))
					.over(Complex.sqrt(this.relativeMagneticPermeabilities[wavelengthIndex][1]));
			...
			if (this.numberOfLayers > 3) {
				...
				for (int i = 2; i < this.numberOfLayers - 1; i++) {
					costheta = this.kxVector[wavelengthIndex][angleIndex][i]
							.over(this.kVector[wavelengthIndex][angleIndex][i]);
					pTerm = (this.refractiveIndices[wavelengthIndex][i].over(this.impedance))
							.over(Complex.sqrt(this.relativeMagneticPermeabilities[wavelengthIndex][i]));
					pTerm = pTerm.times(costheta);
			...
			Complex pTerm0 = (this.refractiveIndices[wavelengthIndex][0].over(this.impedance))
					.over(Complex.sqrt(this.relativeMagneticPermeabilities[wavelengthIndex][0]));
			pTerm0 = pTerm0.times(costheta);

			costheta = this.kxVector[wavelengthIndex][angleIndex][this.numberOfLayers - 1]
					.over(this.kVector[wavelengthIndex][angleIndex][this.numberOfLayers - 1]);
			Complex pTermN = (this.refractiveIndices[wavelengthIndex][this.numberOfLayers - 1].over(this.impedance))
					.over(Complex.sqrt(this.relativeMagneticPermeabilities[wavelengthIndex][this.numberOfLayers - 1]));
			...
			tempc4 = tempc1.plus(tempc2);
			this.reflectCoeffTE[wavelengthIndex][angleIndex] = tempc3.over(tempc4);
			this.reflectPhaseShiftRadTE[wavelengthIndex][angleIndex] = this.reflectCoeffTE[wavelengthIndex][angleIndex]
					.arg();
			this.reflectPhaseShiftDegTE[wavelengthIndex][angleIndex] = Math
					.toDegrees(this.reflectPhaseShiftRadTE[wavelengthIndex][angleIndex]);

			tempc3 = pTerm0.times(2.0D);
			this.transmitCoeffTE[wavelengthIndex][angleIndex] = tempc3.over(tempc4);
			this.transmitPhaseShiftRadTE[wavelengthIndex][angleIndex] = this.transmitCoeffTE[wavelengthIndex][angleIndex]
					.arg();
			this.transmitPhaseShiftDegTE[wavelengthIndex][angleIndex] = Math
					.toDegrees(this.transmitPhaseShiftRadTE[wavelengthIndex][angleIndex]);
		}

		// Calculate and return reflectivity, transmissivity, transmitted angle,
		// evanescent field
		double reflectivity = Fmath.square(this.reflectCoeffTE[wavelengthIndex][angleIndex].getReal())
				+ Fmath.square(this.reflectCoeffTE[wavelengthIndex][angleIndex].getImag());

		int nkouter = this.numberOfLayers - 1;
		double tempd1 = Fmath.square(this.transmitCoeffTE[wavelengthIndex][angleIndex].getReal())
				+ Fmath.square(this.transmitCoeffTE[wavelengthIndex][angleIndex].getImag());
		tempc2 = (this.relativeMagneticPermeabilities[wavelengthIndex][0]
				.over(this.relativeMagneticPermeabilities[wavelengthIndex][nkouter])).times(tempd1);
		tempc3 = this.kxVector[wavelengthIndex][angleIndex][nkouter].conjugate()
				.over(this.kxVector[wavelengthIndex][angleIndex][0]);
		...
		if (this.kxVector[wavelengthIndex][angleIndex][nkouter].getReal() == 0.0D) {
			...
			integratedEvanescentField = Fmath.square(this.transmitCoeffTE[wavelengthIndex][angleIndex].abs())
					* (1.0D - Math.exp(-2.0D * this.fieldDistance / penetrationDepth)) * penetrationDepth / 2.0D;
			if (this.fieldDistance != Double.POSITIVE_INFINITY)
				this.fieldIntensityCalc = true;
		} else {
			transmissivity = complexTransmissivity.getReal();
			reflectedAngleRad = Math.atan2(this.kzVector[wavelengthIndex][angleIndex][nkouter].getReal(),
					this.kxVector[wavelengthIndex][angleIndex][nkouter].getReal());
		}
	...
	public double[] calcTMreflectivity(int wavelengthIndex, int angleIndex) {
		...
		if (this.numberOfLayers == 2) {
			tempc1 = Complex.square(this.refractiveIndices[wavelengthIndex][1])
					.times(this.kxVector[wavelengthIndex][angleIndex][0]);
			tempc2 = Complex.square(this.refractiveIndices[wavelengthIndex][0])
					.times(this.kxVector[wavelengthIndex][angleIndex][1]);
			tempc3 = tempc1.minus(tempc2);
			tempc4 = tempc1.plus(tempc2);
			...
			tempc4 = tempc1.plus(tempc2);
			this.reflectCoeffTM[wavelengthIndex][angleIndex] = tempc3.over(tempc4);
			this.reflectPhaseShiftRadTM[wavelengthIndex][angleIndex] = this.reflectCoeffTM[wavelengthIndex][angleIndex]
					.arg();
			this.reflectPhaseShiftDegTM[wavelengthIndex][angleIndex] = Math
					.toDegrees(this.reflectPhaseShiftRadTM[wavelengthIndex][angleIndex]);

			tempc3 = pTerm0.times(2.0D);
			this.transmitCoeffTM[wavelengthIndex][angleIndex] = tempc3.over(tempc4);
			this.transmitPhaseShiftRadTM[wavelengthIndex][angleIndex] = this.transmitCoeffTM[wavelengthIndex][angleIndex]
					.arg();
			this.transmitPhaseShiftDegTM[wavelengthIndex][angleIndex] = Math
					.toDegrees(this.transmitPhaseShiftRadTM[wavelengthIndex][angleIndex]);
		}

		// Calculate and return reflectivity, transmissivity, transmitted angle,
		// evanescent field
		double reflectivity = Fmath.square(this.reflectCoeffTM[wavelengthIndex][angleIndex].getReal())
				+ Fmath.square(this.reflectCoeffTM[wavelengthIndex][angleIndex].getImag());

		int nkouter = this.numberOfLayers - 1;
		double tempd1 = Fmath.square(this.transmitCoeffTM[wavelengthIndex][angleIndex].getReal())
				+ Fmath.square(this.transmitCoeffTM[wavelengthIndex][angleIndex].getImag());
		tempc2 = Complex.square(
				this.refractiveIndices[wavelengthIndex][0].over(this.refractiveIndices[wavelengthIndex][nkouter]))
				.times(tempd1);
		tempc3 = this.kxVector[wavelengthIndex][angleIndex][nkouter].conjugate()
				.over(this.kxVector[wavelengthIndex][angleIndex][0]);
		Complex complexTransmissivity = tempc2.times(tempc3);
		...
		if (this.kxVector[wavelengthIndex][angleIndex][nkouter].getReal() == 0.0D) {
			penetrationDepth = 1.0D / this.kxVector[wavelengthIndex][angleIndex][nkouter].getImag();
			double refrTerm = this.refractiveIndices[wavelengthIndex][0].getReal()
					/ this.refractiveIndices[wavelengthIndex][nkouter].getReal();
			double magnTerm = Math.sqrt(this.relativeMagneticPermeabilities[wavelengthIndex][nkouter].getReal()
					/ this.relativeMagneticPermeabilities[wavelengthIndex][0].getReal());
			integratedEvanescentField = Fmath.square(this.transmitCoeffTM[wavelengthIndex][angleIndex].abs()) * magnTerm
					* refrTerm * (1.0D - Math.exp(-2.0D * this.fieldDistance / penetrationDepth)) * penetrationDepth
					/ 2.0D;
			if (this.fieldDistance != Double.POSITIVE_INFINITY)
				this.fieldIntensityCalc = true;
		} else {
	...
	// Enter indices of imaginary parts of the refractive indices to be
	// estimated
	public void setImagRefractIndexEstimateIndices(int[] indices) {
		...
		// Transfer absorption coefficient estimate indices to Imag[refractive
		// index] estimate indices list
		if (this.absorptionCoeffEstimateSet) {
			...
			for (int i = 0; i < this.numberOfLayers; i++) {
				...
				for (int j = 0; j < this.absorptionCoeffEstimateNumber; j++) {
					if (i == this.absorptionCoeffEstimateIndices[j])
						testA = true;
				}
				if (!testR && testA) {
					temp0[newIndex] = i;
	...
	// Enter indices of real parts of the relative magnetic permeabilities to be
	// estimated
	...
	// Enter indices of imaginary parts of the relative magnetic permeabilities
	// to be estimated
	...
	public void fitReflectivities(double[] experimentalReflectivities, double[] errors) {
		...
		if (this.numberOfDataPoints != errors.length)
			throw new IllegalArgumentException("Number of data points, " + this.numberOfDataPoints
					+ " is not equal to the number of errors (weights), " + errors.length + ".");
		if (this.incidentAngleSet) {
			if (this.numberOfDataPoints != this.numberOfIncidentAngles)
				throw new IllegalArgumentException("Number of experimental reflectivities " + this.numberOfDataPoints
						+ " does not equal the number of incident angles " + this.numberOfIncidentAngles);
	...
	public void fitTransmissivities(double[] experimentalTransmissivities, double[] errors) {
		...
		if (this.incidentAngleSet) {
			if (this.numberOfDataPoints != this.numberOfIncidentAngles)
				throw new IllegalArgumentException("Number of experimental transmissivities " + this.numberOfDataPoints
						+ " does not equal the number of incident angles " + this.numberOfIncidentAngles);
	...
	public void nonLinearRegression() {
		...
		if (this.degreesOfFreedom < 1)
			throw new IllegalArgumentException("Number of parameters to be estimated, "
					+ this.numberOfEstimatedParameters + ", is greater than or equal to the number of data points, "
		...
		for (int i = 0; i < this.magneticPermRealEstimateNumber; i++) {
			init[pIndex] = this.relativeMagneticPermeabilities[0][this.magneticPermRealEstimateIndices[pIndex]]
					.getReal();
			start[pIndex] = init[pIndex];
			step[pIndex] = init[pIndex] * 0.1D;
			if (step[pIndex] == 0.0D)
		...
		for (int i = 0; i < this.magneticPermImagEstimateNumber; i++) {
			init[pIndex] = this.relativeMagneticPermeabilities[0][this.magneticPermImagEstimateIndices[pIndex]]
					.getImag();
			start[pIndex] = init[pIndex];
			step[pIndex] = init[pIndex] * 0.1D;
			if (step[pIndex] == 0.0D)
		...
		// calculate scaling factor estimate if evanescent field fitting option
		// chosen
		if (this.regressionOption == 3) {
		...
		for (int i = 0; i < this.magneticPermRealEstimateNumber; i++) {
			this.relativeMagneticPermeabilities[0][this.magneticPermRealEstimateIndices[pIndex]]
					.setReal(bestEstimates[pIndex]);
			pIndex++;
		}
		for (int i = 0; i < this.magneticPermImagEstimateNumber; i++) {
			this.relativeMagneticPermeabilities[0][this.magneticPermImagEstimateIndices[pIndex]]
					.setImag(bestEstimates[pIndex]);
			pIndex++;
		}
		if (this.regressionOption == 3)
		...
		case 3: // evanescent field fitting
			...
			for (int i = 0; i < this.numberOfDataPoints; i++)
				this.calculatedData[i] *= this.fieldScalingFactor;
			break;
		default:
			throw new IllegalArgumentException("Regresion option " + regressionOption + " does not exist");
		}
	}
	...
	public void plotFit(String graphTitle2) {
		...
		// calculated data
		double angleIncrement = (this.incidentAngleDeg[this.numberOfIncidentAngles - 1] - this.incidentAngleDeg[0])
				/ (numberOfCalculatedDataPoints - 1);
		data[2][0] = this.incidentAngleDeg[0];
		for (int i = 1; i < numberOfCalculatedDataPoints - 1; i++)
			data[2][i] = data[2][i - 1] + angleIncrement;
		...
		case 3: // evanescent field fitting
			...
			for (int i = 0; i < numberOfCalculatedDataPoints; i++)
				data[3][i] *= this.fieldScalingFactor;
...
// evanescent fields over a range of angles
class RegressFunct implements RegressionFunction {

	public int numberOfLayers = 0; // number of layers
	public String mode = null; // polarisation mode: TE, TM, unpolarised or
								// mixed
	...
	public Complex[][] relativeMagneticPermeabilities = null; // relative
																// magnetic
																// permeabilities
	public int regressionOption = 0; // Regression option
										// = 1; reflectivity versus angle
										// = 2; transmissivity versus angle
										// = 3; evanescent field versus angle
	public int[] thicknessEstimateIndices = null; // indices of the thicknesses
													// to be estimated by
													// non-linear regression
	public int[] refractIndexRealEstimateIndices = null; // indices of the
															// Real[refractive
															// indices] to be
															// estimated by
															// non-linear
															// regression
	public int[] refractIndexImagEstimateIndices = null; // indices of the
															// Imag[refractive
															// indices] to be
															// estimated by
															// non-linear
															// regression
	public int[] magneticPermRealEstimateIndices = null; // indices of the
															// Real[relative
															// magnetic
															// permeability] to
															// be estimated by
															// non-linear
															// regression
	public int[] magneticPermImagEstimateIndices = null; // indices of the
															// Imag[relative
															// magnetic
															// permeability] to
															// be estimated by
