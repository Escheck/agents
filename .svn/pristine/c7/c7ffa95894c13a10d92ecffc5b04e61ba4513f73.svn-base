...
public class Group2 extends AbstractNegotiationParty {
	...
	public void init(NegotiationInfo info) {
		...
		ourUtilitySpace = new G2UtilitySpace((AdditiveUtilitySpace) utilitySpace);
	...
	public void receiveMessage(AgentID sender, Action action) {
		...
		if (DefaultAction.getBidFromAction(action) != null) {
			...
			if (!opponentModels.containsKey(sender)) {
				opponentModels.put(sender, new G2OpponentModel((AdditiveUtilitySpace) getUtilitySpace()));
			}
