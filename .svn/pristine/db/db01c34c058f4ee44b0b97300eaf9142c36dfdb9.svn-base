...
public class Gangster extends Agent {
	...
	public void init() {
		...
		try {
			...
			if (utilitySpace instanceof NonlinearUtilitySpace) {
				genAlg = new GenAlg((NonlinearUtilitySpace) utilitySpace, INIT_GENERATION_SIZE, NUM_SURVIVORS,
	...
	public Action chooseAction() {
		...
		try {
			...
			if (lastProposedByUs == null || lastProposedByUs.bidDetails == null
				...
				return new Offer(getAgentID(), utilitySpace.getDomain().getRandomBid(null));
			}

			return new Offer(getAgentID(), lastProposedByUs.bidDetails.getBid());
	...
	public String getDescription() {
		return "ANAC 2014 - Gangster (compatible with non-linear utility spaces)";
	}
